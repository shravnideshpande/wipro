...
public class LandlordController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Landlord> fetchLandlordDetails(@PathVariable("id") @Positive int landlordId) {
	...
	@PutMapping("/update")
	public ResponseEntity<Landlord> updateLandlordn(@Valid @RequestBody Landlord landlord) {
